...
public class RestApiCall {
    public static void main(String[] args) throws IOException {
        ...
        // Create JSON body
        String jsonBody = "{\"model\": \"gpt-4o-mini\",\"ssn\": \"666-66-6666\", \"messages\": [{\"role\": \"user\", \"content\": \"whose phone number is 408-555-5555\"}]}";
...
public class RestApiCallThree {
    public static void main(String[] args) throws IOException {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost httpPost = new HttpPatch("https://api.openai.com/v1/messages");
...
public class RestApiCallFour {
    public static void main(String[] args) throws IOException {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost httpPost = new HttpGet("https://api.openai.com/v1/chat/completions?IMEI=358632958148007");
...
public class RestApiCallFive {
    public static void main(String[] args) throws IOException {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost httpPost = new HttpGet("https://api.openai.com/v1/completions?email=testAI@ssc.com");
